...
class ClockEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clock_event" do
    assert_difference('ClockEvent.count') do
      post clock_events_url, params: { clock_event: { event_at: @clock_event.event_at, event_type: @clock_event.event_type, username: @clock_event.username } }
    end
  ...
  test "should update clock_event" do
    patch clock_event_url(@clock_event), params: { clock_event: { event_at: @clock_event.event_at, event_type: @clock_event.event_type, username: @clock_event.username } }
